variable "public_ip_name" {
  type        = string
  description = "Specifies name of the Public IP resource."
}

variable "network_interface_name" {
  type        = string
  description = "Specifies name of the Network Interface resource."
}

variable "virtual_machine_name" {
  type        = string
  description = "Specifies name of the Virtual Machine resource."
}

variable "security_group_name" {
  type        = string
  description = "Specifies name of the Security Group resource."
}
